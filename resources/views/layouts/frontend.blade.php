    ...
    <div class="container">
      <a href="/adminlte/index3.html" class="navbar-brand">
        <img src="/adminlte/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-normal">Gis Sekolah</span>
      </a>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="/kecamatan/{{$data->slug}}" class="dropdown-item">{{$data->kecamatan}} </a></li>
              @endforeach
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="/jenjang/{{$data->slug}}" class="dropdown-item">{{$data->jenjang}} </a></li>
              @endforeach
            </ul>
          </li>
