...
@section('content')
  <div class="col-md-12">
    <div class="card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form role="form" action="/kecamatan/insert" method="POST">
            @csrf
            <div class="row">
                <div class="col-sm-6">
                    <!-- text input -->
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>geoJSON</label>
                        <textarea name="geojson" rows="5" class="form-control @error('geojson') is-invalid @enderror" placeholder="geoJSON...">{{old('geojson')}}</textarea>
                        <div class="text-danger pl-2">
                            @error('geojson')
                                {{$message}}
                            @enderror
