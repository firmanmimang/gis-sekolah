...
@section('content')
  <div class="col-md-12">
    <div class="card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form role="form" action="/user/insert" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-sm-6">
                    <!-- text input -->
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Konfirmasi password..." value="{{old('password_confirmation')}}">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                     ...
                     <div class="input-group">
                       <div class="custom-file">
                         ...
                         <label class="custom-file-label" for="customFile">Pilih foto max 1mb... (not required)</label>
                       </div>
                     </div>
                     <div class="text-danger pl-2">
                      @error('foto')
                 ...
                 <div class="col-sm-6">	
                   <div class="form-group">
                       <img src="/img/nouser.png" id="image_load" width="200px" class="rounded mx-auto d-block my-1">
                   </div>
                 </div>
